...
// Load reads environment configuration and fails fast on missing required values.
func Load() error {
	sharedconfig.LoadDotEnv()

	ServiceName = sharedconfig.ServiceName("AuthService")
	Port = sharedconfig.ServicePort("8081")
